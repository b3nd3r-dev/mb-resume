...
Revision ID: 00d7b5fd88e7
Revises: 
Create Date: 2022-06-26 00:13:19.073309
...
def upgrade():
    ...
    sa.Column('short_description', sa.UnicodeText(), nullable=True),
    ...
    sa.Column('show_on_front', sa.Boolean(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
