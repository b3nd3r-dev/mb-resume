...
about_mes=[{'id': 1, 'title': 'Principal Engineer', 'subtitle': 'Curious of the Unknown & Eager to Learn', 'description': '', 'quote': ''},]

achievements=[{'id': 2, 'name': 'Marist College', 'start_date': '2014', 'end_date': '2017', 'desc': '<p>Bachelors in Computer Science with a GPA of 3.8 and honors.</p>', 'link': None, 'link_name': None, 'icon': 'fas fa-school', 'order': 10},{'id': 3, 'name': 'Help Desk Operator', 'start_date': '2014', 'end_date': '2015', 'desc': '<p>As you may imagine, working at a Help Desk isn’t glamorous but I gained experience in a skill that would prove to be invaluable. I was resetting passwords and helping people out with basic technology issues, and all that time gaining experience talking with customers. We were on the phone or helping people in person, and looking back on this it set me up with a great foundation for discussing technical concepts with people of all backgrounds.</p>', 'link': 'https://www.marist.edu/', 'link_name': 'Marist', 'icon': 'fas fa-info', 'order': 9},{'id': 4, 'name': 'Principal Test Engineer', 'start_date': 'July 2017', 'end_date': 'July 2020', 'desc': "<p>I started with IBM on the Linux Center of Competence team, focusing on testing Linux on Z and&nbsp;driving open source efforts for the platform. Our team's mission was to remove excuses when it came to running software on Linux on Z which granted me the opportunity to work with some incredibly smart people around the world. Being a vocal contributor put me in a position to work with our customers to modernize workflows and drive net new business to the platform.</p>", 'link': 'https://www.ibm.com/us-en/', 'link_name': 'IBM', 'icon': 'fas fa-server', 'order': 7},{'id': 5, 'name': 'KVM Solution Test Lead', 'start_date': 'July 2020', 'end_date': 'April 2022', 'desc': '<p>As a manager on the KVM Solution test team I led a team of six engineers, collaborating with multi-national colleagues. I leveraged my depth of experience in developer roles to guide the team in transforming our testing strategy by using automation to run 24/7 and achieve 100% test coverage. We primarily leveraged Ansible to manage system configurations across different architectures and deploy network, disk and memory test suites verifying scalability and functionality.&nbsp;<br>&nbsp;</p><p>The leadership position required balancing business requirements and deadlines with technical innovation that would set up our team for success in the future. We worked with three major Linux distribution’s (RHEL/SLES/Ubuntu) engineers to test and verify KVM on their respective operating systems. Ultimately the test cycle length was reduced by 37%, and shift-left by five months to align ourselves with our partner’s beta lifecycles.</p>', 'link': 'https://www.ibm.com/us-en/', 'link_name': 'IBM', 'icon': 'fas fa-server', 'order': 6},{'id': 7, 'name': 'Internship/Co-Op', 'start_date': 'December 2015', 'end_date': 'July 2017', 'desc': "<p>During my time at Marist College, I worked for IBM during the school year and summer. It was a challenge to balance school work with my job's responsibilities but gave a lot of opportunities to practice balancing priorities. I mainly functioned as a developer making updates to various test tools written in Java and Bash.</p>", 'link': 'https://www.ibm.com/us-en/', 'link_name': 'IBM', 'icon': 'fas fa-chalkboard', 'order': 8},{'id': 8, 'name': 'IT Manager', 'start_date': 'February 2023', 'end_date': 'Present', 'desc': "<p>Responsible for overseeing technology implementations and enhancing processes for various departments. Utilizing a variety of programming languages I interacted with ERP, accounting and fulfillment APIs to ensure the business is running efficiently and removed snags/headaches. I have built various applications to assist &amp; automate QA/Auditing tasks required from a food service business.</p><p>&nbsp;</p><p>I help the organization learn about growing threats targeting small businesses with phishing and info stealing attacks. Part of this mission is enforcing MFA policies and hosting educational lessons about securing individuals' digital identity. This is in effort to reduce the business's risk when using digital services, and to give individuals a blueprint to secure their individual digital identities. Additionally I implemented DMARC/DKIM and SPF policies, removing threat actor's ability to spoof and impersonate members of our organization via phishing attacks.</p><p>&nbsp;</p><p>At the Runamok plant in Fairfax I deployed distributed mesh WIFI systems to provide quality of life to employees, allowing them to have consistent connection across the entire plant. In an age where everybody interacts with digital services this helped make the organization as a whole more efficient. Once deployed, I designed and implemented security systems to keep the business secure from theft and to have the ability to monitor sensitive areas from anywhere at any time.</p>", 'link': 'https://runamokmaple.com', 'link_name': 'Runamok', 'icon': 'fa-jar', 'order': 1},]
